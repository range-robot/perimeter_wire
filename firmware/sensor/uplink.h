...
inline static uint8_t uplink_get_flags()
{
	return app_registers->config.flags;
}
...
inline static uint8_t uplink_get_filter()
{
	return app_registers->config.filter_size;
}
...
inline static void uplink_reset_measurement_counter()
{
	app_registers->measurement_counter = 0;
}

inline static void uplink_increment_measurement_counter()
{
	app_registers->measurement_counter++;
}
