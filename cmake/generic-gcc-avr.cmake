...
function(add_avr_executable EXECUTABLE_NAME)
   ...
   set_target_properties(
      ...
      PROPERTIES
         ...
         LINK_FLAGS "-mmcu=${AVR_MCU} -Wl,--gc-sections -mrelax -Wl,-Map,${map_file_path}"
   )

   add_custom_command(
      OUTPUT ${hex_file_path}
      COMMAND
         ${AVR_OBJCOPY} -j .text -j .data -O ihex ${elf_file_path} ${hex_file_path}
      COMMAND
         ${AVR_SIZE_TOOL} ${AVR_SIZE_ARGS} ${elf_file_path}
   ...
   add_custom_target(
      ...
      ${AVR_OBJDUMP} -h -S ${elf_file_path} > ${EXECUTABLE_NAME}.lst
      DEPENDS ${elf_file_path}
   )
